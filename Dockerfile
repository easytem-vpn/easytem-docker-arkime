...
RUN apt-get -qq update && \
    apt-get -yq upgrade && \
    apt-get install -yq curl libmagic-dev wget logrotate libwww-perl libjson-perl ethtool libyaml-dev liblua5.4-0 libmaxminddb0 libpcap0.8 libglib2.0-0 libyara8 librdkafka1
